...
export const MetaControllerSchema = z.object({
  ...
  current_summary: z.string().default("Current controller status is not available."),
  current_severity: z.string().default("info"),
  current_checked_at: z.string().nullable().optional(),
  previous_notification: AnyRecord.nullable().optional(),
