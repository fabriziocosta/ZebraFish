...
export default function App() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        const next = await fetchInvestigation(campaign, { view, level, relationDepth });
  ...
  }, [campaign, view, level, relationDepth]);
  ...
  return <main className={theme}>
    ...
    {data && <div className="page-shell">
      ...
      <FocusedGraph data={data} level={level} relationDepth={relationDepth} onLevel={setLevel} onDepth={setRelationDepth} />
    </div>}
